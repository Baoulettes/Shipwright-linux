    ...
    if (globalCtx->pauseCtx.state < 4) {
        switch (globalCtx->sceneNum) {
            ...
            case SCENE_ICE_DOUKUTO:
                ...
                if (CHECK_BTN_ALL(globalCtx->state.input[0].press.button, BTN_L) && !Gameplay_InCsMode(globalCtx) && CVar_GetS32("gDPadShortcuts", 0) != 0 && CVar_GetS32("gDPadShortcutsDisableMinimap", 0) != 0) {
